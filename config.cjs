...
const config = {
  SESSION_ID: process.env.SESSION_ID || "Ethix-MD&ntzsYFgu",
  ...
  AUTO_RECORDING: process.env.AUTO_RECORDING !== undefined ? process.env.AUTO_RECORDING === 'false'
  ...
  OWNER_NUMBER: process.env.OWNER_NUMBER || "94713317339",
